        ...
        >
          ...
          >
            ...
            >
              ...
              <Dumbbell className="w-7 h-7 sm:w-8 sm:h-8 relative z-10 text-white" />
              <div className="flex flex-col leading-[1.1] relative z-10 text-left">
                <span className="text-[10px] uppercase tracking-wider opacity-90 font-medium">See the full</span>
                <span className="text-base sm:text-[20px] font-condensed uppercase tracking-wide">AI Coach</span>
              </div>
            </motion.a>
            ...
            >
              ...
              <div className="flex flex-col leading-[1.1] text-left">
                <span className="text-[10px] uppercase tracking-wider opacity-70 font-medium">See the</span>
                <span className="text-base sm:text-[20px] font-condensed uppercase tracking-wide">Meal Planner</span>
              </div>
            </motion.a>
          </motion.div>
