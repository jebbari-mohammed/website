...
async function generateNewTitles(topVideos, trendingTopics, allPreviousTitles) {
  ...
  const prompt = `You are a YouTube content strategist for a fitness app called "IZEM" (youraicoach.life).
...
5. Every title MUST include one of: "IZEM", "AI Fitness App", "AI Personal Trainer", "AI Coach"
...
Example:
[
  {"title": "IZEM vs Fitbod — Which Is Better in 2026?", "slug": "review-vs-fitbod-2026", "type": "comparison"},
